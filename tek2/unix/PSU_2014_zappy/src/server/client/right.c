/*
** right.c for  in /home/gicque_p/project/tek2/unix/PSU_2014_zappy/src/server/client
** 
** Made by Pierrick Gicquelais
** Login   <gicque_p@epitech.net>
** 
** Started on  Mon Jun 22 17:25:18 2015 Pierrick Gicquelais
** Last update Sun Jun 28 13:35:42 2015 Pierrick Gicquelais
*/

#include	"server/commands_client.h"

void		right(t_server *server, t_client *client, char *str)
{
  char		*s;

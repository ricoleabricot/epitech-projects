/*
** protocol.c for  in /home/gicque_p/project/tek2/unix/PSU_2014_myftp
** 
** Made by Pierrick Gicquelais
** Login   <gicque_p@epitech.net>
** 
** Started on  Sat Mar 28 20:21:36 2015 Pierrick Gicquelais
** Last update Sat Mar 28 20:29:30 2015 Pierrick Gicquelais
*/
...
void		pasv(t_client *cli)
{
  ...
  scmd = split_string(ret, '(', 1);
  ip = get_ip(scmd);
  port = get_port(scmd);
  init_passive(cli->data, ip, port);
